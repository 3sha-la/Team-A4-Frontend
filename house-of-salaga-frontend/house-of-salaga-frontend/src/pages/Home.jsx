      ...
      <div className="flex-1 min-w-0 bg-[#FAF9F6] min-h-screen font-sans text-gray-900 pb-10">
        ...
        <header className="max-w-[92%] mx-auto px-6 py-4 flex justify-between items-center bg-white mt-4 rounded-t-xl">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              to="/cart"
              className="bg-[#FFD600] text-black px-5 py-2.5 rounded-full font-bold text-sm flex items-center gap-2 hover:bg-yellow-400 transition"
            >
              <svg
                className="w-4 h-4"
                fill="none"
            ...
            <Link
              to="/login"
              className="border border-gray-300 text-black px-5 py-2.5 rounded-full font-bold text-sm hover:bg-gray-100 transition"
            >
              Login
            </Link>
          </div>
        ...
        <main className="max-w-[92%] mx-auto px-6 bg-white pb-16 rounded-b-xl shadow-sm">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6">
            <div className="bg-[#FFD600] rounded-2xl p-10 md:p-14 flex flex-col justify-center items-start">
              <span className="text-[11px] font-black tracking-widest uppercase mb-4">
                Drop 04 · Everyday Tech
              </span>
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  to="/shop"
                  className="bg-black text-white px-6 py-3.5 rounded-full text-sm font-bold flex items-center gap-2 hover:bg-gray-800 transition"
                >
                  Shop the drop
          ...
          <section className="mt-20">
            <div className="flex justify-between items-end mb-6">
              ...
              <Link
                to="/shop"
                className="text-xs font-bold underline underline-offset-4 hover:text-gray-600"
              >
                View all gear
              </Link>
            </div>
          ...
          <section className="mt-20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                {
                  img: "https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?q=80&w=400",
                  cat: "Audio",
                  title: "Orbit ANC Headphones",
                  price: "$249",
                },
                {
                  img: "https://images.unsplash.com/photo-1585565804112-f201f68c48b4?q=80&w=400",
                  cat: "Charge",
                  title: "Fuse 3-in-1 Dock",
                  price: "$89",
                },
                {
                  img: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?q=80&w=400",
                  cat: "Audio",
                  title: "Loop Mini Speaker",
                  price: "$59",
                },
                {
                  img: "https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?q=80&w=400",
                  cat: "Desk",
                  title: "Axis Laptop Stand",
                  price: "$74",
                },
              ].map((item, i) => (
