...
export default function Profile() {
  // 1. Header Card එකේ පෙන්වන Data (Save කළාට පස්සේ විතරක් වෙනස් වෙනවා)
  ...
  const handleSavePersonal = () => {
    ...
    // Save කළාට පසු පමණක් උඩ Profile Card එක Update වේ
    setProfileHeader({
  ...
  const handleCancelPersonal = () => {
    // Reset inputs back to original Header Data
